...
{
    CPubKey key(ParseHex(user_options.count("testnet") and user_options["testnet"].as<bool>() ? pszTestKey : pszMainKey));
...
bool CAlert::ProcessAlert(bool fThread)
{
...

    {
        ...
        if(AppliesToMe())
        {
            ...
            std::string strCmd = user_options["alertnotify"].as<std::string>();
            if (!strCmd.empty())
            {
